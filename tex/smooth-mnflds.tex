...
\item Moser's trick.
$H^n_{dR}(M^n)=\mathbb{R}$ for closed connected $M$.
De Rham cohomology, degree.
Calculations via symmetry for products of $\mathbb{S}^n$ and maybe $\mathbb{C}\mathrm{P}^n$, as in Spivak's vol. 5,  chapter 13, section 6.
